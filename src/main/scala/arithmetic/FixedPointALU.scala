 ...
 * This ALU only supports opcodes ADD, SUB, MAX, MIN. For multiplications and divisions. If any opcode other than those supported is input,
 * the output is the result of computing io.in.a + io.in.b
 */
